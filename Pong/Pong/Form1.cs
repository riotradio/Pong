    ...
    public partial class Form1 : Form
    {
        ...
        private void timerTick(object sender, EventArgs e)
        {
            ...
            if (ball.Left < 0){
                ...
                ballx = -ballx; // change the ball's direction
                ballx -= 2; // increase the speed
                cpuPoint++; // add one to the CPU score
            }
            ...
            if (ball.Left + ball.Width > ClientSize.Width)
            {
                ...
                score++; // addone to the player's score
            }
            ...
            {
                // then
                // move player towards bottom of screen
                player.Top += 8;
            }
            ...
            // if the player scores more than 10
